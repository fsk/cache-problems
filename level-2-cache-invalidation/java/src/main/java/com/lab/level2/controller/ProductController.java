package com.lab.level2.controller;

import com.lab.level2.dto.ApiResponse;
import com.lab.level2.dto.ProductResponse;
import com.lab.level2.dto.UpdatePriceRequest;
import com.lab.level2.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> updatePrice(
            @PathVariable long id, @RequestBody UpdatePriceRequest request) {
